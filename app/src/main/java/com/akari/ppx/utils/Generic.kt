...
fun commentCell(cellType: Int = 8, cellId: Long, commentText: String) {
    ...
    val publishMediaClass = "com.sup.android.mi.publish.bean.PublishMedia".findClass(cl)
    val commentBean = "com.sup.android.mi.publish.bean.CommentBean".findClass(cl).new(
        arrayOf(
            String::class.java,
    ...
    "com.sup.android.module.publish.publish.c".findClass(cl)
        .getStaticObjectField("b")
        ?.callMethodExact(
            "a",
            arrayOf("com.sup.android.mi.publish.bean.PublishBean".findClass(cl)),
            commentBean
        )
}
